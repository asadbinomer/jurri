         ...
         <div className="w-full px-20 py-24 flex items-center justify-center bg-[#F9F9F9]">
            <div className="w-full max-w-[1400px] flex items-center gap-12 justify-between">
               <div className="max-w-[400px] flex flex-col gap-4">
                  ...
                  <p className='text-lg text-[#0D1C2999] satoshi-500'>With our dedication, expertise, and personalized approach, we have earned their trust and delivered exceptional results time and again.</p>
               </div>
